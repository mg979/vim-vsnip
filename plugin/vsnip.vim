...
function! s:open_command(bang, cmd)
  ...
  let l:dir = exists('b:vsnip_snippet_dir') && isdirectory(b:vsnip_snippet_dir)
        \   ? b:vsnip_snippet_dir : g:vsnip_snippet_dir

  if l:dir == g:vsnip_snippet_dir && !isdirectory(g:vsnip_snippet_dir)
